...
\begin{itemize}
    ...
    %\item Synthetic German minority is constructed as a linear combination of control ethnic groups based on matching of pre-treatment arrests and other covariates
...
\begin{itemize}
   % \item 
    ...
    \end{itemize}
    %\item Small positive effects of geopolitical hostility without war bordering on being statistically significant 
